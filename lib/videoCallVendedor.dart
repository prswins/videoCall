...
class VideoCallV2Vendedor extends StatefulWidget {
  @override
  _VideoCallV2VendedorState createState() => _VideoCallV2VendedorState();
}

class _VideoCallV2VendedorState extends State<VideoCallV2Vendedor> {
  JanusClient j;
  ...
  Registros registro = Registros("VideoCallV2Vendedor");
  ...
  String userCall = "aguardando conexao";
  ...
  makeCall() async {
    ...
    var body = {"request": "call", "username": "cliente01"};
    publishVideo.send(
      data: body,
      jsep: offerToCall,
    );
